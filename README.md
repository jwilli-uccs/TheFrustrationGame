...
Use WASD keys to move forwards, backwards, and sideways.
The space bar will cause the player character to Jump.
...
Pressing any key other than WASD, Space, 0, 1, 2, and Q will result in Competence related frustration.

To cycle between the 3 frustration methods, Keyboard, Devin, and Isaac, use the keys 0, 1, and 2.
